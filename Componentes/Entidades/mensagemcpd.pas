...
type
  TMensagemCPD = class(TSQuery)
    private
      { Private fields of TMensagemCPD }
      ...
      { Private methods of TMensagemCPD }
    ...
    protected
      { Protected fields of TMensagemCPD }

      { Protected methods of TMensagemCPD }
        { Resets prop of component type if referenced component deleted }
        procedure Notification(AComponent : TComponent; Operation : TOperation); override;
        procedure Loaded; override;

    public
      { Public fields and properties of TMensagemCPD }
        { Controla o estado da entidade(0-normal,1-Inserção,2-Alteração) }
        Estado : Integer;

      { Public methods of TMensagemCPD }
        { Altera uma Mensagem }
        ...
        { Insere uma Mensagem }
        function Inserir(CdCNC, CdMSG, PDestinoCNC, PDestinoUSU, PSituacaoEnviar, PSituacaoReceber : Integer; PAssunto,PMensagem, PObs: String;PPublica,PUrgente,PAvisarLeitura:boolean):boolean;
    ...
    published
      { Published properties of TMensagemCPD }
...
procedure Register;
begin
     { Register TMensagemCPD with Softech as its
       default page on the Delphi component palette }
     RegisterComponents('Softech', [TMensagemCPD]);
end;

{ Method to set variable and property values and create objects }
procedure TMensagemCPD.AutoInitialize;
begin
     Estado := 0;
     FEAssunto := nil;
     FEAvisarLeitura := nil;
...
{ Resets prop of component type if referenced component deleted }
procedure TMensagemCPD.Notification(AComponent : TComponent; Operation : TOperation);
begin
...
{ Method to free any objects created by AutoInitialize }
procedure TMensagemCPD.AutoDestroy;
begin
     { No objects from AutoInitialize to free }
end; { of AutoDestroy }

{ Read method for property Apagada }
function TMensagemCPD.GetApagada : Boolean;
begin
  try
...
{ Write method for property Apagada }
procedure TMensagemCPD.SetApagada(Value : Boolean);
begin
...
{ Read method for property Assunto }
function TMensagemCPD.GetAssunto : String;
begin
  try
...
{ Write method for property Assunto }
procedure TMensagemCPD.SetAssunto(Value : String);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
  try
...
{ Read method for property AvisarLeitura }
function TMensagemCPD.GetAvisarLeitura : Boolean;
begin
  try
...
{ Write method for property AvisarLeitura }
procedure TMensagemCPD.SetAvisarLeitura(Value : Boolean);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
   try
     if value=true then
...
{ Read method for property CodigoCNC }
function TMensagemCPD.GetCodigoCNC : Integer;
begin
  try
...
{ Write method for property CodigoCNC }
procedure TMensagemCPD.SetCodigoCNC(Value : Integer);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
    try
...
{ Read method for property CodigoMSG }
function TMensagemCPD.GetCodigoMSG : Integer;
begin
  try
...
{ Write method for property CodigoMSG }
procedure TMensagemCPD.SetCodigoMSG(Value : Integer);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
    try
...
{ Read method for property CodigoUSU }
function TMensagemCPD.GetCodigoUSU : Integer;
begin
  try
...
{ Write method for property CodigoUSU }
procedure TMensagemCPD.SetCodigoUSU(Value : Integer);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
    try
...
{ Read method for property DataAlterado }
function TMensagemCPD.GetDataAlterado : TDateTime;
begin
  try
...
{ Write method for property DataAlterado }
procedure TMensagemCPD.SetDataAlterado(Value : TDateTime);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
  try
...
{ Read method for property DataCadastro }
function TMensagemCPD.GetDataCadastro : Tdatetime;
begin
  try
...
{ Write method for property DataCadastro }
procedure TMensagemCPD.SetDataCadastro(Value : Tdatetime);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
  try
...
{ Read method for property DestinoCNC }
function TMensagemCPD.GetDestinoCNC : Integer;
begin
  try
...
{ Write method for property DestinoCNC }
procedure TMensagemCPD.SetDestinoCNC(Value : Integer);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
  try
...
{ Read method for property DestinoUSU }
function TMensagemCPD.GetDestinoUSU : Integer;
begin
  try
...
{ Write method for property DestinoUSU }
procedure TMensagemCPD.SetDestinoUSU(Value : Integer);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
  try
...
{ Read method for property Mensagem }
function TMensagemCPD.GetMensagem : String;
begin
  try
...
{ Write method for property Mensagem }
procedure TMensagemCPD.SetMensagem(Value : String);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
  try
...
{ Read method for property Obs }
function TMensagemCPD.GetObs : String;
begin
  try
...
{ Write method for property Obs }
procedure TMensagemCPD.SetObs(Value : String);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
  try
...
{ Read method for property Publica }
function TMensagemCPD.GetPublica : Boolean;
begin
  try
...
{ Write method for property Publica }
procedure TMensagemCPD.SetPublica(Value : Boolean);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
   try
     if value=true then
...
{ Read method for property SituacaoEnviar }
function TMensagemCPD.GetSituacaoEnviar : Integer;
begin
  try
...
{ Write method for property SituacaoEnviar }
procedure TMensagemCPD.SetSituacaoEnviar(Value : Integer);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
  try
...
{ Read method for property SituacaoReceber }
function TMensagemCPD.GetSituacaoReceber : Integer;
begin
  try
...
{ Write method for property SituacaoReceber }
procedure TMensagemCPD.SetSituacaoReceber(Value : Integer);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
  try
...
{ Read method for property Urgente }
function TMensagemCPD.GetUrgente : Boolean;
begin
 try
...
{ Write method for property Urgente }
procedure TMensagemCPD.SetUrgente(Value : Boolean);
begin
  if (Self.State=dsEdit) or (Self.State=dsInsert) then
   try
     if value=true then
...
{ Altera uma Mensagem }
function TMensagemCPD.Alterar(CdCNC, CdMSG, PDestinoCNC, PDestinoUSU, PSituacaoEnviar, PSituacaoReceber: Integer; PAssunto, PMensagem, PObs: String; PPublica, PUrgente, PAvisarLeitura:boolean):boolean;
begin
...
function TMensagemCPD.AlterarAuto:Boolean;
begin
    try
      edit;
      try
...
procedure TMensagemCPD.AtualizaControles(Habilitar:Boolean);
...
procedure TMensagemCPD.CancelaEdicao;
     { Internal declarations for method }
     { type }
     { . . . }
     { var }
...
procedure TMensagemCPD.CarregaDados;
begin
  Try
...
constructor TMensagemCPD.Create(AOwner: TComponent);
begin
...
function TMensagemCPD.Deletar(CdCNC, CdMSG: Integer):Boolean;
begin
  If not(localizarCod(CdMSG, CdCNC)) Then
  Begin
    Result := False;
...
destructor TMensagemCPD.Destroy;
begin
...
function TMensagemCPD.FinalizaEdicao:Boolean;
var
  cod, cdcnc:Integer;
...
{ Insere uma Mensagem }
function TMensagemCPD.Inserir(CdCNC, CdMSG, PDestinoCNC, PDestinoUSU, PSituacaoEnviar, PSituacaoReceber : Integer; PAssunto,PMensagem, PObs: String;PPublica,PUrgente,PAvisarLeitura:boolean):boolean;
Var
  Cod:Integer;
begin
  if CdMSG=0 then
...
function TMensagemCPD.InserirAuto:Boolean;
begin
    try
      append;
      try
...
{ Localiza uma Mensagem }
function TMensagemCPD.LocalizarCod(CdMSG, CdCNC: Integer): Boolean;
     { Internal declarations for method }
     { type }
     { . . . }
     { var }
...
function TMensagemCPD.LocalizarNome(PAssunto:String):Boolean;
     { Internal declarations for method }
     { type }
     { . . . }
     { var }
...
procedure TMensagemCPD.PreparaAlteracao;
     { Internal declarations for method }
     { type }
     { . . . }
     { var }
...
procedure TMensagemCPD.PreparaInsercao;
     { Internal declarations for method }
     { type }
     { . . . }
     { var }
...
function TMensagemCPD.deletarauto:Boolean;
begin
  try
    Result := Delete;
  Except
