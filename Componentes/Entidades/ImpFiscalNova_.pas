...
Uses
  ...
  Menus, StdCtrls;
   ...
   Function Bematech_FI_AberturaDoDia(ValorFormaPagamento, FormaPagamento: String): Integer; StdCall; External 'BEMAFI32.DLL';
   Function Bematech_FI_MapaResumo(): Integer; StdCall; External 'BEMAFI32.DLL';
   Function Bematech_FI_EfetuaFormaPagamentoDescricaoForma(FormaPagamento, ValorFormaPagamento, Descricao: String): Integer; StdCall; External 'BEMAFI32.DLL';
   Function Bematech_FI_FechamentoDoDia(): Integer; StdCall; External 'BEMAFI32.DLL';
   Function Bematech_FI_ImprimeConfiguracoesImpressora(): Integer; StdCall; External 'BEMAFI32.DLL';
   Function Bematech_FI_VerificaIndiceAliquotasIss(IndiceAliquotas: String ): Integer; StdCall; External 'BEMAFI32.DLL';
//   Function Bematech_FITEF_ADM( Identificacao: String): Integer; StdCall; External 'BEMAFI32.DLL';
//   Function Bematech_FITEF_CancelaVendaCartao(Indentificacao, Valor, NSU, NumeroCupom, Data, Hora, Rede: String): Integer; StdCall; External 'BEMAFI32.DLL';
//   Function Bematech_FITEF_ConfirmaVenda(Valor, Header: String): Integer; StdCall; External 'BEMAFI32.DLL';
//   Function Bematech_FITEF_ImprimeRelatorio(): Integer; StdCall; External 'BEMAFI32.DLL';
//   Function Bematech_FITEF_NaoConfirmaVendaImpressao(Identificacao, Valor: String): Integer; StdCall; External 'BEMAFI32.DLL';
//   Function Bematech_FITEF_Status(Identificacao: String): Integer; StdCall; External 'BEMAFI32.DLL';
//   Function Bematech_FITEF_VendaCompleta(Identificacao, Valor, FormaPagamento, MensagemPromocional: String): Integer; StdCall; External 'BEMAFI32.DLL';
//   Function Bematech_FITEF_VendaCartao(Identificacao, Valor: String): Integer; StdCall; External 'BEMAFI32.DLL';
//   Function Bematech_FITEF_ImprimeTEF(Identificador, FormaPagamento, Valor: String): Integer; StdCall; External 'BEMAFI32.DLL';
   Function Bematech_FI_RelatorioTipo60Analitico(): Integer; StdCall; External 'BEMAFI32.DLL';
   Function Bematech_FI_RelatorioTipo60Mestre(): Integer; StdCall; External 'BEMAFI32.DLL';
  ...
  function Daruma_FI_ProgramaCaracterAutenticacao( Parametros: String ): Integer; StdCall; External 'Daruma32.dll';
  ...
  function Daruma_FI_ProgramaMoedaSingular( MoedaSingular: String ): Integer; StdCall; External 'Daruma32.dll';
  function Daruma_FI_ProgramaMoedaPlural( MoedaPlural: String ): Integer; StdCall; External 'Daruma32.dll';
  function Daruma_FI_CancelaImpressaoCheque: Integer; StdCall; External 'Daruma32.dll';
  function Daruma_FI_VerificaStatusCheque( Var StatusCheque: Integer ): Integer; StdCall; External 'Daruma32.dll';
  function Daruma_FI_ImprimeCheque( Banco: String; Valor: String; Favorecido: String; Cidade: String; Data: String; Mensagem: String ): Integer; StdCall; External 'Daruma32.dll';
  function Daruma_FI_IncluiCidadeFavorecido( Cidade: String; Favorecido: String ): Integer; StdCall; External 'Daruma32.dll';
  function Daruma_FI_ImprimeCopiaCheque: Integer; StdCall; External 'Daruma32.dll' Name 'Daruma_FI_ImprimeCopiaCheque';
  // Outras Funções
