...
type
  Trpt_ImprimirChequeBNB = class(TForm)
    report: TSZReport;
    ZRBand1: TSZRBand;
...
var
  rpt_ImprimirChequeBNB: Trpt_ImprimirChequeBNB;
...
procedure Trpt_ImprimirChequeBNB.ZRBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
const
...
procedure Trpt_ImprimirChequeBNB.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Entidade.Close;
  CentroCusto1.Close;
  Cliente1.Close;
...
procedure Trpt_ImprimirChequeBNB.FormCreate(Sender: TObject);
begin
  Entidade := Cheque1;
end;
