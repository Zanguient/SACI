...
type
  Trpt_clienteAniversariante = class(TForm)
    report: TSZReport;
    ZRBand1: TSZRBand;
    ZRBand3: TSZRBand;
    ZRLabel2: TSZRLabel;
...
var
  rpt_clienteAniversariante: Trpt_clienteAniversariante;
const
...
procedure Trpt_clienteAniversariante.FormCreate(Sender: TObject);
begin
 Cliente1.Active:= true;
end;

procedure Trpt_clienteAniversariante.FormClose(Sender: TObject;
...
procedure Trpt_clienteAniversariante.ZRBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_clienteAniversariante.SZRBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ...
  SZRLabel11.Caption := Trim(DM.SelecionaParametro(Cliente1.Logradouro)+' '+Cliente1.Endereco);
end;

procedure Trpt_clienteAniversariante.ZRBand3BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
