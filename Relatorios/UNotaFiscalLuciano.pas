...
type
  Trpt_NotaFiscalLuciano = class(TForm)
    report: TSZReport;
...
var
  rpt_NotaFiscalLuciano: Trpt_NotaFiscalLuciano;
...
procedure Trpt_NotaFiscalLuciano.FormClose(Sender: TObject;
...
procedure Trpt_NotaFiscalLuciano.zrbDetalheBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
var
  sDescricao: string;
begin
...
procedure Trpt_NotaFiscalLuciano.SZRDBText8BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_NotaFiscalLuciano.zrlPesoBrutoBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_NotaFiscalLuciano.SZRDBText7BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_NotaFiscalLuciano.SZRDBText28BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_NotaFiscalLuciano.SZRDBText3BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_NotaFiscalLuciano.SZRExpression1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_NotaFiscalLuciano.zrlAliquotaBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_NotaFiscalLuciano.SZRExpression2BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_NotaFiscalLuciano.SZRDBText4BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_NotaFiscalLuciano.FormCreate(Sender: TObject);
begin
  VendaPrazo := False;
...
procedure Trpt_NotaFiscalLuciano.Item_Nota_Fiscal10AfterOpen(
  DataSet: TDataSet);
begin
  NotaFiscal10.Close;
...
procedure Trpt_NotaFiscalLuciano.zrbCabecalhoBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
var
...
procedure Trpt_NotaFiscalLuciano.zrbRodapePaginaBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
var
  sOBS: TStringList;
begin
