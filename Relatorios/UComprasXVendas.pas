...
type
  Trpt_Compras_X_Vendas = class(TForm)
    report: TSZReport;
    ZRBand1: TSZRBand;
    zrlDetalhe: TSZRBand;
    ZRBand3: TSZRBand;
...
var
  rpt_Compras_X_Vendas: Trpt_Compras_X_Vendas;
...
procedure Trpt_Compras_X_Vendas.FormClose(Sender: TObject;
...
procedure Trpt_Compras_X_Vendas.FormCreate(Sender: TObject);
begin
  Entidade := Produto1;
...
procedure Trpt_Compras_X_Vendas.zrlDetalheBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
var
...
begin
  ...
  begin
    ...
    zrlSaldoPreco.Caption   := format('%.2f',[vTotalVendaPreco-vTotalCompraPreco]);
  end;
end;

procedure Trpt_Compras_X_Vendas.ZRBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_Compras_X_Vendas.ZRBand3BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_Compras_X_Vendas.zrbGrupoBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  vPRDEstoque      := 0;
  vPRDQTDVendas    := 0;
...
procedure Trpt_Compras_X_Vendas.zrbRodapeGrupoBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ...
  zrlPRDSaldoPreco.Caption   := format('%.2f',[vPRDVendaPreco-vPRDCompraPreco]);
end;

procedure Trpt_Compras_X_Vendas.zrbSumarioBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ...
  zrlGeralSaldoPreco.Caption   := format('%.2f',[vGeralVendaPreco-vGeralCompraPreco]);
end;
