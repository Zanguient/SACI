...
type
  Trpt_ImprimirChequeReal = class(TForm)
    report: TSZReport;
    ZRBand1: TSZRBand;
...
var
  rpt_ImprimirChequeReal: Trpt_ImprimirChequeReal;
...
procedure Trpt_ImprimirChequeReal.ZRBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
const
...
procedure Trpt_ImprimirChequeReal.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Entidade.Close;
  CentroCusto1.Close;
  Cliente1.Close;
...
procedure Trpt_ImprimirChequeReal.FormCreate(Sender: TObject);
begin
  Entidade := Cheque1;
end;
