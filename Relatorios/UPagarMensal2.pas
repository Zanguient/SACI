...
uses
  ...
  Conta_de_Caixa, CentroCusto, Titulo_a_Pagar, funcoes;

type
  Trpt_PagarMensal2 = class(TForm)
    report: TSZReport;
    ZRBand1: TSZRBand;
    ZRBand2: TSZRBand;
    ZRBand3: TSZRBand;
    ...
    Titulo_a_pagar1ANO: TIntegerField;
    Titulo_a_pagar1MES: TIntegerField;
...
var
  rpt_PagarMensal2: Trpt_PagarMensal2;
...
procedure Trpt_PagarMensal2.FormClose(Sender: TObject;
...
procedure Trpt_PagarMensal2.ZRLabel3BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_PagarMensal2.ZRBand2BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_PagarMensal2.reportBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  SomaAno:=0;
  Somames:=0;
...
procedure Trpt_PagarMensal2.ZRBand6AfterPrint(Sender: TObject;
  Printed: Boolean);
begin
  SomaAno:=0;
end;

procedure Trpt_PagarMensal2.ZRBand5AfterPrint(Sender: TObject;
  Printed: Boolean);
begin
  Somames:=0;
end;

procedure Trpt_PagarMensal2.ZRBand6BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ZRLabel18.Caption:=Format('%.2f',[SomaAno]);
end;

procedure Trpt_PagarMensal2.ZRBand5BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_PagarMensal2.ZRBand4BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_PagarMensal2.Titulo_a_pagar1CalcFields(DataSet: TDataSet);
begin
  Case Titulo_a_pagar1.FieldByName('mes').AsInteger of
...
procedure Trpt_PagarMensal2.ZRBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ZRLabel1.Caption:=DM.CentroCusto1.RazaoSocial;
end;

procedure Trpt_PagarMensal2.ZRBand3BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
