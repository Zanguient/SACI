...
type
  Trpt_RecebidosMensal2 = class(TForm)
    report: TSZReport;
    ZRBand1: TSZRBand;
    ZRBand2: TSZRBand;
    ZRBand3: TSZRBand;
...
var
  rpt_RecebidosMensal2: Trpt_RecebidosMensal2;
...
procedure Trpt_RecebidosMensal2.FormClose(Sender: TObject;
...
procedure Trpt_RecebidosMensal2.ZRLabel3BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_RecebidosMensal2.ZRBand2BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_RecebidosMensal2.reportBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  SomaAno:=0;
  Somames:=0;
...
procedure Trpt_RecebidosMensal2.ZRBand6AfterPrint(Sender: TObject;
  Printed: Boolean);
begin
  SomaAno:=0;
end;

procedure Trpt_RecebidosMensal2.ZRBand5AfterPrint(Sender: TObject;
  Printed: Boolean);
begin
  Somames:=0;
end;

procedure Trpt_RecebidosMensal2.ZRBand6BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ZRLabel18.Caption:=Format('%.2f',[SomaAno]);
end;

procedure Trpt_RecebidosMensal2.ZRBand5BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_RecebidosMensal2.Titulo_receber1CalcFields(DataSet: TDataSet);
begin
...
procedure Trpt_RecebidosMensal2.ZRBand4BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_RecebidosMensal2.ZRBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ZRLabel1.Caption:=DM.CentroCusto1.RazaoSocial;
end;

procedure Trpt_RecebidosMensal2.ZRBand3BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
