...
procedure Trpt_Carta2.SZRSubDetailBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  DoPrint := Imprimir;
end;

procedure Trpt_Carta2.ZRBand2BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
Var
...
procedure Trpt_Carta2.SZRGroup1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_Carta2.FormCreate(Sender: TObject);
begin
  Entidade := Titulo_receber1;
end;

procedure Trpt_Carta2.SZRBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
