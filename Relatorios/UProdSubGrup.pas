...
var
  rpt_prodSubGrup: Trpt_prodSubGrup;
...
procedure Trpt_prodSubGrup.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
 Produto1.Active:=false;
end;

procedure Trpt_prodSubGrup.FormCreate(Sender: TObject);
begin
 Produto1.Active:=true;
end;

procedure Trpt_prodSubGrup.ZRLabel12BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_prodSubGrup.Produto1BeforeOpen(DataSet: TDataSet);
begin
 Produto1.ParamByName('CODIGO').AsInteger := DM.Configuracao1.CodigoCNC;
end;

procedure Trpt_prodSubGrup.ZRLabel3BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ZRLabel3.Caption:=DM.Configuracao1.LojaNome;
end;

procedure Trpt_prodSubGrup.ZRBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ZRLabel1.Caption:=DM.CentroCusto1.RazaoSocial;
end;

procedure Trpt_prodSubGrup.ZRBand3BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
