...
var
  rpt_Renegociacao: Trpt_Renegociacao;
...
procedure Trpt_Renegociacao.ZRBand2BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ValorComJuros:=0;
...
procedure Trpt_Renegociacao.ZRGroup1AfterPrint(Sender: TObject;
  Printed: Boolean);
begin
  Soma:=0;
end;

procedure Trpt_Renegociacao.ZRLabel3BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ZRLabel3.Caption:=Dm.Configuracao1.LojaNome;
end;

procedure Trpt_Renegociacao.reportBeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ValorSemJuros:=0;
end;

procedure Trpt_Renegociacao.ZRBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ZRLabel1.Caption:=DM.CentroCusto1.RazaoSocial;
end;

procedure Trpt_Renegociacao.FormClose(Sender: TObject;
...
procedure Trpt_Renegociacao.SZRSubDetailBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
  ValorComJuros:=0;
  ...
  if Titulo_receber2.Situacao = 2 then
  Begin
    SZRLabel4.Caption:='';
    SZRLabel11.Enabled := True;
  end
  else
  Begin
    SZRLabel4.Caption:=Format('%.2f',[ValorComJuros]);
    SZRLabel11.Enabled := False;
  end;
...
procedure Trpt_Renegociacao.SZRBand2BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
...
procedure Trpt_Renegociacao.ZRBand3BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
begin
