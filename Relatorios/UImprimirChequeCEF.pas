...
type
  Trpt_ImprimirChequeCEF = class(TForm)
    report: TSZReport;
    ZRBand1: TSZRBand;
...
var
  rpt_ImprimirChequeCEF: Trpt_ImprimirChequeCEF;
...
procedure Trpt_ImprimirChequeCEF.ZRBand1BeforePrint(Sender: TObject;
  var DoPrint: Boolean);
const
...
procedure Trpt_ImprimirChequeCEF.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Entidade.Close;
  CentroCusto1.Close;
  Cliente1.Close;
...
procedure Trpt_ImprimirChequeCEF.FormCreate(Sender: TObject);
begin
  Entidade := Cheque1;
end;
