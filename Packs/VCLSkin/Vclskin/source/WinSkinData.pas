...
type
  ...
  TSkinOption = (xoMDIScrollbar,xoMenuMerge,xoTransparent,xoPreview,xoParentBackGround,
   xoNoFocusRect,xoToolbarBK,xoMDIChildBorder,xoMenuBG);
  ...
  TOnNewForm   = procedure(Sender:TObject;ahwnd:HWND;aName:string) of object;
  ...
  public
    ...
    property OnNewForm     :TOnNewForm read fOnNewform write fOnNewform;
  published
