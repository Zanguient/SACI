...
begin
   ...
   begin
      ...
      txtDataProcessamento2.Caption   := FormatDateTime('dd/mm/yyyy',Titulo.DataProcessamento);
...
begin
   ...
   begin
    ...
    txtDataProcessamento4.Caption   := FormatDateTime('dd/mm/yyyy',Titulo.DataProcessamento);
