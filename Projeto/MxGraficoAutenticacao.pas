...
type
  TfMxGraficoAutenticacao = class(TForm)
    GroupBox1: TGroupBox;
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
var
  fMxGraficoAutenticacao: TfMxGraficoAutenticacao;
...
procedure TfMxGraficoAutenticacao.BitBtn1Click(Sender: TObject);
var
  iCoord      : Integer;
  cCoordenadas: String;
  sTamanho    : String;
...
//  SIAC.ImpFiscalB1.ProgramaGraficoAutenticacao(cCoordenadas);
//  if SIAC.ImpFiscalB1.IRetorno = 1 then
//   Close;
end;

procedure TfMxGraficoAutenticacao.BitBtn2Click(Sender: TObject);
begin
  Close;
end;

procedure TfMxGraficoAutenticacao.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TfMxGraficoAutenticacao.FormShow(Sender: TObject);
begin
