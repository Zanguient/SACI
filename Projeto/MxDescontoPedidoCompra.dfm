object fMxDescontoPedidoCompra: TfMxDescontoPedidoCompra
  Left = 411
  Top = 286
  ...
  object Item_Pedido_Compra1: TItem_Pedido_Compra
    DatabaseName = 'DBguerra'
    SQL.Strings = (
      'SELECT * FROM ITEM_DE_PEDIDO_DE_COMPRA'
      'WHERE CNC_CODIGO=:CNC_CODIGO'
      'AND PCP_CODIGO=:PCP_CODIGO')
    CNCOrigem = 0
    CentroDeCusto = 2
    CodigoCNC = 0
    CodigoUSU = 0
