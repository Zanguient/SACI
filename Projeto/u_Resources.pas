...
begin
  ...
  if not Existe_Arquivo(sFile) then
  begin
    Application.MessageBox('Não foi possível extrair AtualizaSistema.exe'+#13+
...
begin
  ...
  if not Existe_Arquivo(sFile) then
  begin
    Application.MessageBox('Não foi possível extrair PAtualizaSACI.exe'+#13+
                           'Tente reiniciar o computador e execute o programa novamente.',
...
begin
  ...
  if not Existe_Arquivo(sFile) then
  begin
    Application.MessageBox('Não foi possível extrair LibWebBrowser.dll'+#13+
                           'Tente reiniciar o computador e execute o programa novamente.',
...
begin
  ...
  if not Existe_Arquivo(sFile) then
  begin
    Application.MessageBox('Não foi possível extrair SiacReport.dll'+#13+
                           'Tente reiniciar o computador e execute o programa novamente.',
