object frmListaPedidoPAF: TfrmListaPedidoPAF
  Left = 301
  Top = 171
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Importa'#231#227'o de dados do PAF'
  ClientHeight = 406
  ClientWidth = 727
  Color = clBtnFace
  ...
  object qPedidos: TQuery
    ...
    Left = 36
    Top = 370
    object qPedidosCNC_CODIGO: TIntegerField
      FieldName = 'CNC_CODIGO'
    end
    object qPedidosPDV_CODIGO: TIntegerField
      FieldName = 'PDV_CODIGO'
    end
    object qPedidosPDV_DATA_HORA: TDateTimeField
      FieldName = 'PDV_DATA_HORA'
    end
    object qPedidosPDV_TOTAL: TFloatField
      FieldName = 'PDV_TOTAL'
    end
    object qPedidosCLI_CODIGO: TIntegerField
      FieldName = 'CLI_CODIGO'
    end
    object qPedidosCLI_RZ_SOCIAL: TStringField
      FieldName = 'CLI_RZ_SOCIAL'
      FixedChar = True
      Size = 60
    end
    object qPedidosPDV_COO: TStringField
      FieldName = 'PDV_COO'
      FixedChar = True
    end
  end
