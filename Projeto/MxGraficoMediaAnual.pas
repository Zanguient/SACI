...
type
  TfMxGraficoMediaAnual = class(TForm)
    DBChart1: TDBChart;
...
var
  fMxGraficoMediaAnual:TfMxGraficoMediaAnual;
...
procedure TfMxGraficoMediaAnual.FormShow(Sender: TObject);
begin
...
procedure TfMxGraficoMediaAnual.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key=chr(27) then
    Close;
...
procedure TfMxGraficoMediaAnual.aImprimir1Execute(Sender: TObject);
begin
  DBChart1.PrintLandscape;
end;

procedure TfMxGraficoMediaAnual.aFechar1Execute(Sender: TObject);
begin
  Close;
end;

procedure TfMxGraficoMediaAnual.aCopiar3Execute(Sender: TObject);
begin
  DBChart1.CopyToClipboardMetafile(True);
end;

procedure TfMxGraficoMediaAnual.aAjuda2Execute(Sender: TObject);
begin
  Application.HelpCommand(HELP_FINDER, 1);
end;

procedure TfMxGraficoMediaAnual.aSobre2Execute(Sender: TObject);
begin
  Application.CreateForm(TfMxSobre, fMxSobre);
  fMxSobre.ShowModal;
end;

procedure TfMxGraficoMediaAnual.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TfMxGraficoMediaAnual.ckb3DClick(Sender: TObject);
begin
  DBChart1.View3D := ckb3D.Checked;
  spe3D.Enabled   := ckb3D.Checked;
end;

procedure TfMxGraficoMediaAnual.spe3DChange(Sender: TObject);
begin
  DBChart1.Chart3DPercent := spe3D.Value;
end;

procedure TfMxGraficoMediaAnual.spePtsPageChange(Sender: TObject);
begin
  DBChart1.MaxPointsPerPage := spePtsPage.Value;
end;

procedure TfMxGraficoMediaAnual.bbtnPreviousPageClick(Sender: TObject);
begin
...
procedure TfMxGraficoMediaAnual.ckbLegendaClick(Sender: TObject);
begin
...
procedure TfMxGraficoMediaAnual.rdgPosicaoLegendaClick(Sender: TObject);
begin
  DBChart1.Legend.Alignment := TLegendAlignment(rdgPosicaoLegenda.ItemIndex);
end;

procedure TfMxGraficoMediaAnual.ckbMarcas1Click(Sender: TObject);
begin
  Series1.Marks.Visible := ckbMarcas1.Checked;
  cmbTipoMarcas1.Enabled    := ckbMarcas1.Checked;
end;

procedure TfMxGraficoMediaAnual.aExibirBarra4Execute(Sender: TObject);
begin
  if LendoProps then
...
procedure TfMxGraficoMediaAnual.cmbStyle1Change(Sender: TObject);
begin
 Series4.LineBrush := TBrushStyle(cmbStyle1.itemindex);
//  Series1.BarStyle := TBarStyle(cmbStyle1.itemindex);
end;

procedure TfMxGraficoMediaAnual.cmbTipoMarcas1Change(Sender: TObject);
begin
...
procedure TfMxGraficoMediaAnual.cmbTipoLegendaChange(Sender: TObject);
begin
...
procedure TfMxGraficoMediaAnual.clbCorLegendaFundoChange(Sender: TObject);
begin
  DBChart1.Legend.Color := clbCorLegendaFundo.Selected;
end;

procedure TfMxGraficoMediaAnual.clbCorLegendaTextoChange(
  Sender: TObject);
begin
  DBChart1.Legend.Font.Color := clbCorLegendaTexto.Selected;
end;

procedure TfMxGraficoMediaAnual.ckbMarcas2Click(Sender: TObject);
begin
  Series2.Marks.Visible  := ckbMarcas2.Checked;
  cmbTipoMarcas2.Enabled := ckbMarcas2.Checked;
end;

procedure TfMxGraficoMediaAnual.cmbTipoMarcas2Change(Sender: TObject);
begin
...
procedure TfMxGraficoMediaAnual.cmbStyle2Change(Sender: TObject);
begin
//  Series2.BarStyle := TBarStyle(cmbStyle2.itemindex);
end;

procedure TfMxGraficoMediaAnual.FormCreate(Sender: TObject);
begin
  LendoProps := False;
  LerPreferencias(fMxGraficoMediaAnual,'C:\SACI\GraficoMediaAnual.cfg');
  LendoProps := True;
end;

procedure TfMxGraficoMediaAnual.FormDestroy(Sender: TObject);
begin
  SalvarPreferencias(fMxGraficoMediaAnual,'C:\SACI\GraficoMediaAnual.cfg',
    ...
    'cmbStyle1.ItemIndex','cmbStyle2.ItemIndex','cmbStyle4.ItemIndex',
...
procedure TfMxGraficoMediaAnual.ckbSeries1Click(Sender: TObject);
begin
...
procedure TfMxGraficoMediaAnual.ckbSeries2Click(Sender: TObject);
begin
...
procedure TfMxGraficoMediaAnual.ckbSeries3Click(Sender: TObject);
begin
...
procedure TfMxGraficoMediaAnual.ckbMarcas3Click(Sender: TObject);
begin
  Series3.Marks.Visible  := ckbMarcas3.Checked;
  cmbTipoMarcas3.Enabled := ckbMarcas3.Checked;
end;

procedure TfMxGraficoMediaAnual.cmbTipoMarcas3Change(Sender: TObject);
begin
...
procedure TfMxGraficoMediaAnual.cmbStyle3Change(Sender: TObject);
begin
//  Series3.BarStyle := TBarStyle(cmbStyle3.itemindex);
end;

procedure TfMxGraficoMediaAnual.ckbSeries4Click(Sender: TObject);
begin
...
procedure TfMxGraficoMediaAnual.cmbStyle4Change(Sender: TObject);
begin
//  Series4.BarStyle := TBarStyle(cmbStyle4.itemindex);
end;

procedure TfMxGraficoMediaAnual.ckbMarcas4Click(Sender: TObject);
begin
  Series4.Marks.Visible  := ckbMarcas4.Checked;
  cmbTipoMarcas4.Enabled := ckbMarcas4.Checked;
end;

procedure TfMxGraficoMediaAnual.cmbTipoMarcas4Change(Sender: TObject);
begin
