object fMxResumoPedido: TfMxResumoPedido
  Left = 200
  Top = 118
  ...
  object Panel1: TPanel
    ...
    object edtAgenteFinanceiro: TEdit
      Left = 5
      Top = 75
      Width = 116
      Height = 21
    ...
    object libItensPedido: TListBox
      Left = 5
      Top = 189
      Width = 781
      Height = 302
      ...
      Items.Strings = (
          ...
          '00000 PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP 00000 0' +
          '0000 00000  00000000  00000000 00000')
      ParentFont = False
      TabOrder = 7
    end
    object memResumo: TMemo
      Left = 434
      Top = 5
      Width = 349
      Height = 149
  ...
  object Panel2: TPanel
    ...
    BevelOuter = bvNone
    TabOrder = 1
    object SB_ImprimirPedido: TSpeedButton
      Left = 530
      Top = 7
      Width = 79
      Height = 25
      ...
      ShowHint = True
      OnClick = SB_ImprimirPedidoClick
    end
    object SB_ImprimirResumo: TSpeedButton
      Left = 608
      Top = 7
      Width = 79
      Height = 25
      ...
      ParentShowHint = False
      ShowHint = True
      OnClick = SB_ImprimirResumoClick
    end
    ...
    object ckbParcelasProdutos: TCheckBox
      Left = 408
      Top = 11
      Width = 112
      Height = 17
      Cursor = crHandPoint
      Caption = 'Parcelas (Produtos)'
      Checked = True
      State = cbChecked
      TabOrder = 1
    end
