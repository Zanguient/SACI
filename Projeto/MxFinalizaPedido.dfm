object fMxFinalizaPedido: TfMxFinalizaPedido
  Left = 324
  Top = 207
  BorderIcons = [biSystemMenu]
  BorderStyle = bsDialog
  Caption = 'Selecionar Tipo de Pedido'
  ClientHeight = 174
  ClientWidth = 288
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object rdbNormal: TRadioButton
      ...
      Width = 144
      Height = 17
      Caption = 'Normal (Fatura Imediata)'
      Checked = True
      TabOrder = 0
      TabStop = True
    ...
    object rdbPendente: TRadioButton
      ...
      Width = 144
      Height = 17
      Caption = 'Faturamento Pendente'
      TabOrder = 2
      OnClick = rdbNormalClick
    end
    object rdbRemessa: TRadioButton
      Left = 20
      Top = 88
      Width = 172
      Height = 17
      Caption = 'Remessa (Pacote de Venda):'
      TabOrder = 3
      OnClick = rdbNormalClick
    end
    object edtCodigoPDV: TEdit
      ...
      Enabled = False
      TabOrder = 4
      OnKeyPress = edtCodigoPDVKeyPress
    end
    object rdbPrePago: TRadioButton
      Left = 20
      Top = 45
      Width = 158
      Height = 17
      Caption = 'Remessa (Pr'#233'-Paga):'
      TabOrder = 1
      OnClick = rdbNormalClick
    end
  ...
  object Pacote_de_venda1: TPacote_de_venda
    DatabaseName = 'DBguerra'
    SQL.Strings = (
      'SELECT TOP 1 PDV_CODIGO'
